  ...
  return (
    <div id='landing' className="font-sans">
      ...
      <main className="px-12">
        {/* Hero Section */}
        <section className="grid md:grid-cols-2 items-center py-16 relative">
          <div className='w-full h-full'>
            <div className='bg-teal-50 p-12 h-full rounded-t-2xl rounded-b-none rounded-r-none'>
              ...
              <button className="flex items-center font-semibold mb-6 gap-2">
                <i class="ti ti-player-play-filled text-teal-500 bg-white p-2 rounded-full"></i> Watch video
              </button>
            </div>
          </div>
          <section className="flex shadow-md absolute bottom-24 right-14 bg-white rounded-full">
            ...
            <button className="text-xl bg-green-600 text-white rounded-full rounded-l-none px-12 w-full md:w-auto flex items-center gap-3">
        ...
        {/* Servicios */}
        <section className="py-16 grid grid-cols-5 gap-4">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4 col-span-3">
            {["Cabinas", "Parqueaderos", "Zonas de descanso", "Wifi Alta velocidad", "Tomas de carga", "Seguridad", "Climatización", "Otros"].map((s, i) => (
              <div key={i} className="p-6 border border-gray-400 shadow-sm rounded-xl text-center text-sm flex flex-col gap-2">
                <i class="ti ti-ad-circle text-5xl text-teal-600"></i>
                {s}
              </div>
            ))}
          </div>
        ...
        <section className="py-16 grid md:grid-cols-3 items-center mr-16">
          <img src="/user.jpg" alt="Perfect Place Logo" className="w-[400px] ml-auto rounded-2xl shadow-2xl" />
          <div className="bg-teal-100 p-16 col-span-2 rounded-r-2xl">
