    ...
    <div className="min-h-screen font-sans text-gray-900">
      ...
      <main className="px-8 py-12 gap-8 flex flex-col max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-6 gap-8">
          <div class="col-span-4">
            ...
            <section className="mt-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-8 text-sm text-gray-700">
                ...
                <span>✔ Café o Snacks Incluidos</span>
                <span>✔ Wifi</span>
                <span>✔ Seguridad en la Sala</span>
                <span>✔ Televisor</span>
                <span>✔ Lockers</span>
          ...
          <aside className="col-span-2 border rounded-xl p-6 shadow-sm h-fit">
            ...
            <div className="mt-4">
              <div className="grid grid-cols-2">
                <div>
                  <label className="text-sm font-medium block">TIME-IN</label>
                  <input type="time" defaultValue="08:00" className="border rounded rounded-b-none w-full p-2" />
                </div>

                <div>
                  <label className="text-sm font-medium block">TIME-OUT</label>
                  <input type="time" defaultValue="12:00" className="border rounded rounded-b-none w-full p-2" />
                </div>

                <div className="col-span-2 border rounded  rounded-t-none">
              ...
              <button className="bg-green-600 text-white w-full py-2 rounded hover:bg-green-700 transition">Reservar</button>

              <details className="mt-4 text-sm">
                <summary className="cursor-pointer font-medium">Detalles del Pago</summary>
                <ul className="mt-2 space-y-1">
                  <li>$25.000 x 4 Horas — $100.000</li>
                  <li>Cargo por Limpieza — $10.000</li>
                  <li>Cargo por Servicios — $5.000</li>
                  <li>Mantenimiento Tecnológico — $8.000</li>
                  <li>IVA — $23.370</li>
                  <li className="font-semibold">Total — $146.370</li>
                </ul>
              </details>
        ...
        <div>
          ...
          <section className="mt-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <p className="text-sm">Limpieza</p>
                <p className="text-sm">Calidad del mobiliario</p>
                <p className="text-sm">Conectividad</p>
              </div>
              <div>
                <p className="text-sm">Equipamiento tecnológico</p>
                <p className="text-sm">Valor</p>
                <p className="text-sm">Privacidad acústica</p>
              </div>
            </div>
